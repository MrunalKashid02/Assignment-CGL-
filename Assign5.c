...
//Roll No-23238
//Batch-F10
//Assignment5-implement cohen sutherland polygon clipping method to clip the polygon with respect the viewport and window. use mouse click keyboard intertface
